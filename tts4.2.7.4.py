...
class VoiceGeneratorApp:
        ...
        for idx, folder in enumerate(txt_files):
            ...
            combo_box_path.bind("<<ComboboxSelected>>",
                                lambda e, cbc=combo_box_charactor,
                                       cbp=combo_box_path_var: self.update_charactor_options(cbc, cbp))
    ...
    def on_charactor_selected(self, idx, char_var, start_col, audio_file, prompt_var, ref_language_var,
